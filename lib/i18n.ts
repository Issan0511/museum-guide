...
const translations: Record<UserLanguage, SectionTranslations> = {
  ja: {
    ...
    chatbot: {
      ...
      hintTitle: "AI に質問できます",
      hintDescription: "この工芸について気になることがあれば、右下のアイコンから AI に質問できます。",
      hintAction: "チャットを開く",
  ...
  en: {
    ...
    chatbot: {
      ...
      hintTitle: "You can ask the AI",
      hintDescription: "If you are curious about this craft, you can ask the AI from the icon in the bottom right.",
  ...
  zh: {
    ...
    chatbot: {
      ...
      hintTitle: "可以向 AI 提问",
      hintDescription: "如果你对这项工艺有任何疑问，可以通过右下角的图标向 AI 提问。",
      hintAction: "打开聊天",
      hintDismiss: "关闭聊天提示",
      typing: "正在生成回复...",
  ...
  fr: {
    ...
    craftGrid: {
      ...
      categoryLabels: {
        "住": "Category \"Habitat\"",
        "礼": "Category \"Cérémonie\"",
        "食": "Category \"Alimentation\"",
        "職": "Category \"Travail\"",
        "衣": "Category \"Vêtements\"",
        "その他": "Category \"Autre\""
      }
    },
    craftPage: {
    ...
    chatbot: {
      ...
      hintTitle: "Vous pouvez poser une question à l'IA",
      hintDescription: "Si quelque chose vous intrigue au sujet de cet artisanat, vous pouvez poser une question à l'IA depuis l'icône en bas à droite.",
  ...
  ko: {
    ...
    chatbot: {
      ...
      hintTitle: "AI에게 질문할 수 있습니다",
      hintDescription: "이 공예에 대해 궁금한 점이 있다면 오른쪽 아래 아이콘에서 AI에게 질문할 수 있습니다.",
      hintAction: "채팅 열기",
  ...
  es: {
    ...
    craftGrid: {
      ...
      categoryLabels: {
        "住": "Category \"Vivienda\"",
        "礼": "Category \"Ceremonia\"",
        "食": "Category \"Gastronomía\"",
        "職": "Category \"Trabajo\"",
        "衣": "Category \"Vestimenta\"",
        "その他": "Category \"Otros\""
      }
    },
    craftPage: {
    ...
    chatbot: {
      ...
      hintTitle: "Puedes preguntar a la IA",
      hintDescription: "Si tienes curiosidad sobre esta artesanía, puedes preguntar a la IA desde el icono de abajo a la derecha.",
